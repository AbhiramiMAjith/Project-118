...
train_data = pd.read_csv("PRO-C118-Project-Boilerplate-main/static/assets/datafiles/updated_product_dataset.csv")
training_sentences = []
...
model = load_model("PRO-C118-Project-Boilerplate-main/static/assets/model/sentiment_analysis_model.h5")
