...
def save():
    ...
    with open("C:/Users/Abhirami M Ajith/Downloads/PRO-C118-Project-Boilerplate-main/PRO-C118-Project-Boilerplate-main/static/assets/datafiles/updated_product_dataset.csv") as f:
        f.write(data_entry)
